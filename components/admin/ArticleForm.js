...
export default function ArticleForm({ mode, initialData }) {
  ...
  async function handleSubmit(e) {
    ...
    if (youtubeUrl.trim() && !getYoutubeVideoId(youtubeUrl.trim())) {
      setError("That doesn't look like a valid YouTube URL — check it and try again.");
      return;
    }
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="admin-card">
        ...
        <div className="admin-field">
          ...
          />
          <p className="hint">
            Paste any YouTube link (watch, youtu.be or shorts). It&rsquo;ll show right under the
            title when the article is read.
          </p>
        </div>
